...
class AllCard:
    def __init__(self, obj: dict):
        ...
        for Id, Value in obj.items():
            self.CardData[Id] = Card(Value)  # create Card characteristics one by one
    ...
    def getAtt(self, card_id):
        ...
        :return:
        """
        return self.CardData[card_id].Att
    ...
    def getDef(self, card_id):
        ...
        :return:
        """
        return self.CardData[card_id].Def
    ...
    def getPrice(self, card_id):
        ...
        :return:
        """
        return self.CardData[card_id].Price
    ...
    def getRarity(self, card_id):
        ...
        :return:
        """
        return self.CardData[card_id].Rarity
    ...
    def getName(self, card_id):
        ...
        :return:
        """
        return self.CardData[card_id].Name
    ...
    def getDesc(self, card_id):
        ...
        :return:
        """
        return self.CardData[card_id].Desc
    ...
    def getObj(self, card_id):
        ...
        :return:
        """
        return self.CardData[card_id].obj
